...
contract Challenges is Base {
    ...
    function isDesignatedShelterer(address sheltererId, bytes32 challengeId) public view returns (bool) {
        return challengesStore.isDesignatedShelterer(sheltererId, challengeId);
    }
